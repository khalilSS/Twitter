...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "RI4AA2WX47nwZIzkYU8WqU3HL", consumerSecret: "hPPGNE5YlOtOo4Zq1gsiwq4tD6pNUdzLLac4am6pkCSFJtArWr")
    var loginSuccess: (() -> ())?
